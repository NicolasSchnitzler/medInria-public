...
//#include <itkDataImageRegistery.h>
...
private:
    ...
    //static itkDataImageIntialization init;

    PrivateMember* d;
};

//template <unsigned DIM,typename T,const char* ID> itkDataImageIntialization itkDataImage::init;
